    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            href="/login"
            className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium border border-gm-border
                       text-white/60 hover:text-white hover:border-gm-purple/50 transition-all duration-200"
          >
            Sign In
          </a>
          <a
